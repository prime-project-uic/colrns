...
#'
#' @param object Fitted "colrns.glm" object.
#' @param newx Matrix of new values for x at which predictions are to be made.
#' @param type Type "link" gives the linear predictors. Type "response" gives the fitted probabilities. Default is "response".
#' @return fitted probabilities or linear predictors
#' @keywords prediction
#' @export
#' @examples
#' ### Simulated Data
